...
- **스킬 자동 설치** — `/til`, `/research`, `/backlog`, `/save`, `/recall`, `/dashboard`, `/migrate-links` 명령을 바로 사용 가능
...
→ /til, /backlog, /research, /save, /recall, /dashboard, /migrate-links 스킬 실행
...
| **recall** | `/recall [카테고리]` | SRS 기반 간격 반복 복습 세션 (SM-2 알고리즘) |
